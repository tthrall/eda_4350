...
get_kgl_city_temps <- function(
  ...
  if (read_dnld_file) {
    ...
    here::here(
      "data", "retain", "kaggle-city-temperatures.zip") |>
      zip::unzip(
    ...
    # save as temporary RDS file
    # kgl_city_temps |>
    #   readr::write_rds(file = here::here(
    #     "data", "tmp", "kgl_city_temps.rds"
    #   ))
    ...
    zip::zip(
      files = here::here(
        "data", "tmp", "kgl_city_temps.txt"),
      zipfile = here::here(
        "data", "retain", "kgl_city_temps.zip")
    )

    # compress RDS file and retain
    # zip::zip(
    #   files = here::here(
    #     "data", "tmp", "kgl_city_temps.rds"),
    #   zipfile = here::here(
    ...
    # compressed RDS file -> temporary RDS file
    # here::here(
    #   "data", "retain", "kgl_city_temps.zip") |>
    #   zip::unzip(
    #     files = "kgl_city_temps.rds",
    #     exdir = here::here("data", "tmp")
    #   )

    # read RDS file
    # kgl_city_temps <- readr::read_rds(here(
    #   "data", "tmp", "kgl_city_temps.rds"
    # ))
  }
