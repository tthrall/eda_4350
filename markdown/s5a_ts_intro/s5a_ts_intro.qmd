...
if (save_to_file) {
  # RDS format
  s5a_books_tbl |> readr::write_rds(here::here(
    "data", "retain", "s5a_books_tbl.rds"
  ))

  # TSV format
  s5a_books_tbl |> readr::write_tsv(here::here(
    "data", "retain", "s5a_books_tbl.txt"
  ))
}
```
...
if (save_to_file) {
  # RDS format
  s5a_articles_tbl |> readr::write_rds(here::here(
    "data", "retain", "s5a_articles_tbl.rds"
  ))

  # TSV format
  s5a_articles_tbl |> readr::write_tsv(here::here(
    "data", "retain", "s5a_articles_tbl.txt"
  ))
}
```
