...
[^1]: In rare cases time series methods are applied to data indexed not by time but rather by some other measure, e.g. distance. See for example, D.J. Thompson (1977) "Spectrum Estimation Techniques for Characterization and Development of WT4 Waveguide" <https://doi.org/10.1002/j.1538-7305.1977.tb00591.x>
...
The next figure shows the trading day closings and returns (percent change)[^4] of the Dow Jones Industrial Average (DJIA) from 2006 to 2016. It is easy to spot the financial crisis of 2008.
...
[^6]: The example illustrates a simple moving average. More generally a weighted moving average may have non-negative coefficients that sum to unity.
