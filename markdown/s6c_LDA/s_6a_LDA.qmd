...
output: 
  ...
  pdf_document:
    ...
    df_print: tibble
abstract: 
  "Latent Dirichlet Allocation (LDA): introduce the underlying mathematics and illustrate an example allocation."
---
...
Latent Dirichlet Allocation (LDA) was proposed as a method of topic modeling in 2003 in a paper by Blei, Ng, and Jordan.  The method is briefly mentioned in Part 1 of the course.  This note responds to the request by several course participants for a more detailed description.
...
That is, the random indicator vector $I_{\bullet}$ selects one of the Euclidean basis vector $\{\mathbb{e}_1, \ldots, \mathbb{e}_K \}$ with respective probabilities $(p_1, \ldots, p_K)$. Therefore the expected value of $I_{\bullet}$ equals the vector of category probabilities $p_{\bullet} = (p_1, \ldots, p_K)$.
...
`ml`: "Machine Learning: Topics and Techniques", v 2.93, by Steve Knox.  Reference textbook for MATH4350.
...
[“topicmodels: An R Package for Fitting Topic Models.”](https://www.jstatsoft.org/article/view/v040i13) by Grün B, Hornik K (2011). Journalof Statistical Software, 40(13), 1–30. doi:10.18637/jss.v040.i13.

[David Blei on Topic Modeling](https://www.cs.columbia.edu/~blei/topicmodeling.html)
