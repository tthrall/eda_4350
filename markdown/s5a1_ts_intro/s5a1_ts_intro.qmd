...
We leave the development of such models to a separate technical note.  The point here is that such forecasts are both valued and scrutinized when when presented to support climate-related decisions.
...
# u <- ar.mcmc(
#   rec, porder = 2, n.iter = 1000, plot = FALSE
# )

# now calculate the effective sample size 
# apply(u, 2, ESS)
```
