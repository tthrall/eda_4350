...
where $X_\bullet (\cdot)$ is a two-component time series representing annual global averages of land and ocean temperatures.  This 5-year moving average is an example of a linear, time-invariant _filter_, having the following general form.
