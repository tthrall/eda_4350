...
Then through many iterations the prior distributions $Dir(\alpha_\bullet)$ and $Dir(\delta_\bullet)$ are updated to form posterior distributions based on the data.
