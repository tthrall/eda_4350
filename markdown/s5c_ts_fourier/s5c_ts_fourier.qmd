...
Thus $I_{\bullet, \bullet} (\lambda)$, although asymptotically unbiased, is not a consistent estimate of $f_{a, a} (\lambda)$ since its variance remains large as $n \rightarrow \infty$.
