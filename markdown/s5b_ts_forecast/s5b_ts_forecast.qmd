...
Let $R(\cdot\; | \; \mathcal{p} (t_f))$ denote the residual of the predictors.
...
For fixed $u$ the residual random variable $R(u\; | \; \mathcal{p} (t_f))$ has zero mean and the following finite variance.
