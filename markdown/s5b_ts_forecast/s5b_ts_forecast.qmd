...
In the time series context we introduce the PACF with reference to a univariate, stationary Gaussian process, $\mathcal{N}(t)$, having zero mean.[^Gaussian].
...
Consequently we have the following causal form of the model.[^txt_causal_form]
