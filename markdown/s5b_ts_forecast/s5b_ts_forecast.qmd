...
If the number of data columns is two or greater $(d \ge 2)$, the process is said to be multivariate.  Otherwise, if $d = 1$ the process is said to be univariate, and we the notation is simplified to $X (t)$.
...
The auto-covariance function is often re-scaled to yield the *autocorrelation* function $\rho_{\bullet, \bullet}(\cdot)$.
