...
The exponential smoothing (or EWMA) operation presented above is also called simple exponential smoothing (SES), and belongs to a family of methods called exponential smoothing with trend and seasonality (ETS).  ETS methods encompass (and arose from) Holt-Winters forecasting.[^art-Holt-Winters]

[^art-Holt-Winters]: See @holt1957forecasting and @winters1960forecasting.

These operations are optimal solutions to certain state-space models, distinct from the ARIMA paradigm.
