...
We model the difference $X(t) - \ell (t - 1)$ as a Gaussian white noise process, $W(t)$. [^cf-eq-SES-plus-wn]

[^cf-eq-SES-plus-wn]: @eq-ets-ANN-ss-wn is the state-space version of @eq-SES-plus-wn.
...
Each ETS model can be categorized according to the status of model components level, trend, and season.[^art-ETS-categories]
