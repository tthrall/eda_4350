...
A running average (also called a moving average) of a random process $X(\cdot)$ is a new process $Y(\cdot)$ formed as as a local average of $X$ values.  A _weighted_ running average, with weights $\{ w_u \}_u$ takes the following form.
